...
<template>
  ...
  <button type="button" class="bg-primary text-secondary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-18 px-5 py-2.5 mr-2 mb-2 ">Default</button>

  <button type="button" class="bg-primary text-secondary  px-3">
    test
  </button>
